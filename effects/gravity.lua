...
mcl_beacon.register_effect("gravityquarter", {
	desc_name = "Quarter Gravity",
	info = "25% of the current gravity",
	min_level = 1,
	on_apply = function(player)
		on_apply(player, 0.25, "mcl_beacon_gravityquarter")
	end,
	on_remove = function(player)
		on_remove(player, 0.25, "mcl_beacon_gravityquarter")
	end,
})

mcl_beacon.register_effect("gravityhalf", {
	desc_name = "Half Gravity",
	info = "50% of the current gravity",
	min_level = 1,
	on_apply = function(player)
		on_apply(player, 0.5, "mcl_beacon_gravityhalf")
	end,
	on_remove = function(player)
		on_remove(player, 0.5, "mcl_beacon_gravityhalf")
	end,
})

mcl_beacon.register_effect("gravitydouble", {
	desc_name = "Double Gravity",
	info = "200% of the current gravity",
	min_level = 1,
	on_apply = function(player)
		on_apply(player, 2, "mcl_beacon_gravitydouble")
	end,
	on_remove = function(player)
		on_remove(player, 2, "mcl_beacon_gravitydouble")
	end,
})
