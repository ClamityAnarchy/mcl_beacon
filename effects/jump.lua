...
mcl_beacon.register_effect("jump1", {
	desc_name = "Jump Boost LV1",
	info = "Increases jump power by +25%",
	min_level = 1,
	on_apply = function(player)
		on_apply(player, 1.25, "mcl_beacon_jump1")
	end,
	on_remove = function(player)
		on_remove(player, 1.25, "mcl_beacon_jump1")
	end,
})

mcl_beacon.register_effect("jump2", {
	desc_name = "Jump Boost LV2",
	info = "Increases jump power by +50%",
	min_level = 2,
	overrides = {"jump1"},
	on_apply = function(player)
		on_apply(player, 1.5, "mcl_beacon_jump2")
	end,
	on_remove = function(player)
		on_remove(player, 1.5, "mcl_beacon_jump2")
	end,
})

mcl_beacon.register_effect("jump3", {
	desc_name = "Jump Boost LV3",
	info = "Increases jump power by +75%",
	min_level = 3,
	overrides = {"jump1", "jump2"},
	on_apply = function(player)
		on_apply(player, 1.75, "mcl_beacon_jump3")
	end,
	on_remove = function(player)
		on_remove(player, 1.75, "mcl_beacon_jump3")
	end,
})

mcl_beacon.register_effect("jump4", {
	desc_name = "Jump Boost LV4",
	info = "Increases jump power by +100%",
	min_level = 4,
	overrides = {"jump1", "jump2", "jump3"},
	on_apply = function(player)
		on_apply(player, 2.0, "mcl_beacon_jump4")
	end,
	on_remove = function(player)
		on_remove(player, 2.0, "mcl_beacon_jump4")
	end,
})
